...
import { IssueCode } from 'src/contexts/maintenace/modules/issues/domain/value-objects/issue-code.vo'
import { IssueDescription } from 'src/contexts/maintenace/modules/issues/domain/value-objects/issue-description.vo'
import { IssuePartCategory } from 'src/contexts/maintenace/modules/issues/domain/value-objects/issue-part-category.vo'
import { IssueSeverityLevel } from 'src/contexts/maintenace/modules/issues/domain/value-objects/issue-severity.vo'
import { IssueRequiresGrounding } from 'src/contexts/maintenace/modules/issues/domain/value-objects/issue-requires-grounding.vo'
